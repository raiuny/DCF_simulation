...
def bianchi_ax(data_rate, ack_rate, k, difs):
    ...
    CWmin = 15
    CWmax = 1023
    L_DATA = 1548 * 8 # data size in bits
...
i = 6
bianchi_result = bianchi_ax(data_rates_40MHz[i], ack_rates_40MHz[i], 1, 1)
print(bianchi_result)
# bianchi_result = bianchi_ax(data_rates_20MHz[i], ack_rates_20MHz[i], 1, 0)
# print(bianchi_result)